...
def subjectchoose(text_to_speech):
    def calculate_attendance():
        ...
        if Subject=="":
            ...
            text_to_speech(t)
        os.chdir(
            f"C:\\Users\\NICE\\Documents\\Attendance-Management-system-using-face-recognition\\Attendance\\{Subject}"
        )
        filenames = glob(
            f"C:\\Users\\NICE\\Documents\\Attendance-Management-system-using-face-recognition\\Attendance\\{Subject}\\{Subject}*.csv"
        )
